...
extension SCNVector3 {
    ...
    func dot(with other: SCNVector3) -> Float {
    ...
    func scale(factor: Float) -> SCNVector3 {
        return SCNVector3(x*factor, y*factor, z*factor)
    }
    
    func angleTo(otherVec: SCNVector3) -> Float{
        let dot_product = dot(with: otherVec)
        let lengths = self.length() * otherVec.length()
        let result = acos(dot_product / lengths)
        
        return result
    }
    
    func cross(other: SCNVector3) -> SCNVector3 {
        return SCNVector3Make(y * other.z - z * other.y, z * other.x - x * other.z, x * other.y - y * other.x)
    }
